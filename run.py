...
def parse_arguments():
    ...
    parser.add_argument('--prompt_len', type=int, default=3, help="The parameter of TCL-MAP.")
    ...
    parser.add_argument("--data_path", default = '/home/sharing/disk2/wx/Datasets', type=str,
    ...
    parser.add_argument('--spectra_path', type=str, default='/home/zhanghanlei/zhanghanlei/MOOD/TMM-24/Revision/SPECTRA-base', help="Logger directory.")
    ...
    parser.add_argument("--output_path", default= '/home/sharing/disk1/wx/MMOOD/outputs', type=str, 
...
def set_up(args):
    ...
    if args.method == 'mmood':
        ...
        save_model_name = f"{args.method}_{args.multimodal_method}_{args.dataset}_{args.text_backbone}_{args.data_mode}_{args.seed}"
    elif args.method in ['mult_ood', 'mmim_ood', 'mag_ood']:

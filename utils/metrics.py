...
class OOD_Metrics(object):
    ...
    def __init__(self, args):
        ...
        self.logger = logging.getLogger(args.logger_name)
        self.eval_metrics = ['eer', 'fpr95', 'aupr_in', 'aupr_out', 'auroc', 'der']
    ...
    #     # print(np.isnan(conf).any()) #False
    #     # print(np.isfinite(conf).all()) #True
    #     # print(np.isinf(conf).any()) #False
    ...
    #     fpr_list, tpr_list, threshold_list = roc_curve(gt, conf)
    ...
    def _calculate_eer(self, y_score, y_true):
        # print('111111', y_score)
        # print('222222', y_true)
        # y_true and y_score are NumPy arrays with the true labels and the predicted scores, respectively
...
class OID_Metrics(object):
    ...
    def __init__(self, args):
        ...
        self.logger = logging.getLogger(args.logger_name)
        self.eval_metrics = ['acc', 'f1-known',  'f1-open', 'f1']
